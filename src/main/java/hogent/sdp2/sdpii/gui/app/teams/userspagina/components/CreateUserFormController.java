...
public class CreateUserFormController extends VBox {
    ...
    public CreateUserFormController(WerknemersFacade facade) {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/fmxl/app/teams/components/userspagina/CreateUsersForm.fxml"));
        loader.setRoot(this);
    ...
    private void handleRegistreer() {
        ...
        Task<Boolean> task = new Task<>() {
            ...
            protected Boolean call() {
                return facade.registreerWerknemer(naam, voornaam, email, telefoon, geboortedatumStr, rol);
            }
        };
