...
export default function AppHeader({ onMenuClick }: AppHeaderProps) {
  ...
  return (
    <div
      className={
        'absolute top-0 w-screen z-[9999] flex h-16 md:h-25 flex-row justify-between items-center pl-3 md:pl-5 pr-5 md:pr-14 gap-2 md:gap-5'
      }
    >
      <div className={'h-full flex flex-row gap-2 items-center'}>
        <button
          onClick={onMenuClick}
          className={
            'md:hidden flex items-center justify-center w-8 h-8 rounded-full hover:bg-zinc-100 transition-all duration-300'
          }
      ...
      <div className={'w-fit flex justify-end gap-3 md:gap-5 items-center'}>
        ...
        <div className={'relative flex flex-row'}>
          ...
          >
            ...
            <div
              className={
                'w-fit hidden sm:flex flex-row items-center justify-center'
              }
            >
              <span
                className={
                  'w-full h-full flex items-center pointer-events-none font-bold truncate max-w-32 md:max-w-none'
                }
              >
