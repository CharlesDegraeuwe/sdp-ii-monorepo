package hogent.sdp2.backend.rest.service.teams;
...
public class TeamService {
    ...
    public List<TeamResponseDTO> geefTeamsVanSite(Integer siteId) {
        return teamRepository.findBySiteId(siteId).stream().map(this::toTeamResponse).toList();
    }
    ...
    public List<WerknemerResponseDTO> geefBeschikbareWerknemers(int teamId) {
        List<Integer> huidigeIds =
                teamwerknemerRepository.findByTeamId(teamId).stream()
