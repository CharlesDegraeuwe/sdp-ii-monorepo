...
const PageHeader = () => {
  ...
  return (
    <div
      className={`z-[999] absolute gap-4 rounded-full py-1 pr-1 backdrop-blur-2xl pl-5 ${pageTitle != 'planner' && 'pr-5'} top-9 left-20 flex flex-row justify-center items-center`}
    >
